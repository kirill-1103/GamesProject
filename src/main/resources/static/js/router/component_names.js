...
export const paths = [REGISTER_PAGE_PATH, LOGIN_PAGE_PATH,
    PROFILE_PAGE_PATH, GAME_LIST_PAGE_PATH,RATING_PAGE_PATH, PLAYERS_LIST_PAGE_PATH, CHAT_PAGE_PATH, TTT_GAME_PAGE_PATH,PLAYER_PROFILE_PAGE_PATH, NEW_PLAYER_CHAT_PATH,
    TETRIS_GAME_PAGE_PATH]